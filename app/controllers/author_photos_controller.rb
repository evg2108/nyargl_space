...
class AuthorPhotosController < ApplicationController
  AUTHOR_PHOTOS_PANEL_ID = 'author_photos_panel'
  ...
  def create
    ...
    respond_to do |f|
      f.html do
        ...
        redirect_to author_page_profile_path(anchor: AUTHOR_PHOTOS_PANEL_ID)
      end
